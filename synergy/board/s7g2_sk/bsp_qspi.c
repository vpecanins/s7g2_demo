...
/* Device flag status */
static W25Q64FV_flag_status_1  flag_status1;
static W25Q64FV_flag_status_2  flag_status2;
...
static uint8_t w25q64fv_erase_commands[]=
{
    ...
    0x52,     ///< QSPI COMMAND BLOCK_ERASE
    0xD8,     ///< QSPI_COMMAND SECTOR_ERASE
    0xC7      ///< QSPI_COMMAND CHIP_ERASE
};
/*******************************************************************************************************************//**
...
void bsp_qspi_status_get (bool * p_write_in_progress)
{
    ...
    *p_write_in_progress  =  flag_status1.busy;
}
                          ...
                          bool     * p_xip_mode)
{
    ...
    *p_num_address_bytes  = 3;
    *p_spi_mode           = flag_status2.qe ? 2 : 0;
...
void bsp_qspi_erase_sizes_get(uint32_t ** pp_sizes, uint8_t *p_len)
{
    ...
    *p_len = (sizeof(w25q64fv_flash_erase_sizes)/sizeof(w25q64fv_flash_erase_sizes[0]));
