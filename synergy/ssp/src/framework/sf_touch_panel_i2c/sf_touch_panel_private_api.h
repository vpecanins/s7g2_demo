...
#ifndef SF_TOUCH_PANEL_I2C_PRIVATE_API_H
#define SF_TOUCH_PANEL_I2C_PRIVATE_API_H
 ...
 **********************************************************************************************************************/
ssp_err_t SF_TOUCH_PANEL_I2C_Open(sf_touch_panel_ctrl_t * const p_ctrl, sf_touch_panel_cfg_t const * const p_cfg);
...
#endif /* SF_TOUCH_PANEL_I2C_PRIVATE_API_H */
