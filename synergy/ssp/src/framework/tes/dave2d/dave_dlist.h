...
#define D2_DLISTSHRINKDELAY 60  /* number of frames, for which the number of display list blocks needs too large, before */
                                /*  the number of display list blocks is actually reduced */
