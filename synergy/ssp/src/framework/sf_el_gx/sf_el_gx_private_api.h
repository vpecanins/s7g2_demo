...
#ifndef SF_EL_GX_PRIVATE_API_H
#define SF_EL_GX_PRIVATE_API_H
 ...
 **********************************************************************************************************************/
ssp_err_t SF_EL_GX_Open (sf_el_gx_ctrl_t * const p_ctrl, sf_el_gx_cfg_t const * const p_cfg);
ssp_err_t SF_EL_GX_Close (sf_el_gx_ctrl_t * const p_ctrl);
UINT      SF_EL_GX_Setup (GX_DISPLAY * p_display);
ssp_err_t SF_EL_GX_CanvasInit (sf_el_gx_ctrl_t * const p_ctrl, GX_WINDOW_ROOT * p_window_root);
ssp_err_t SF_EL_GX_VersionGet (ssp_version_t * p_version);

/** Common macro for SSP header files. There is also a corresponding SSP_HEADER macro at the top of this file. */
SSP_FOOTER

#endif /* SF_EL_GX_PRIVATE_API_H */
