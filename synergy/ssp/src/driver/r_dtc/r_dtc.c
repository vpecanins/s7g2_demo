...
static transfer_info_t * gp_dtc_vector_table[BSP_VECTOR_TABLE_MAX_ENTRIES] BSP_ALIGN_VARIABLE(1024) DTC_SECTION_ATTRIBUTE;
#elif __ICCARM__
#pragma data_alignment = 1024
#ifdef DTC_CFG_VECTOR_TABLE_SECTION_NAME
#pragma location = DTC_CFG_VECTOR_TABLE_SECTION_NAME
#endif
static transfer_info_t * gp_dtc_vector_table[BSP_VECTOR_TABLE_MAX_ENTRIES];
#endif
