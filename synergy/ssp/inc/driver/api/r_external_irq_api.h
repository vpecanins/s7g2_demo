 ...
 * Macro definitions
 *********************************************************************************************************************/
#define EXTERNAL_IRQ_API_VERSION_MAJOR (1U)     ///< EXTERNAL IRQ API version number (Major)
#define EXTERNAL_IRQ_API_VERSION_MINOR (2U)     ///< EXTERNAL IRQ API version number (Minor)
